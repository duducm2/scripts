...
global g_WM_MinimizedListThumbnails := []  ; [{ thumbId, sourceHwnd }]
global WM_MINIMIZED_LIST_COL_COUNT := 4
global WM_MINIMIZED_LIST_ROW_COUNT := 2
global WM_MINIMIZED_LIST_COL_GAP := 18
global WM_MINIMIZED_LIST_THUMB_MAX_W := 320
global WM_MINIMIZED_LIST_TITLE_H := 48
global WM_MINIMIZED_LIST_ROW_PAD := 22
global WM_MINIMIZED_LIST_KEY_FONT := 16
global WM_MINIMIZED_LIST_TITLE_FONT := 13
global WM_MINIMIZED_LIST_HEADER_FONT := 14
global WM_MINIMIZED_LIST_MON_LABEL_FONT := 11
global WM_DWM_TNP_RECTDESTINATION := 0x1
global WM_DWM_TNP_VISIBLE := 0x8
global WM_DWM_TNP_SOURCECLIENTAREAONLY := 0x10
