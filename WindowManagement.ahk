...
;   WindowManagement\audio_bt_menu.ahk        - Win+Alt+Shift+9: 1× Push scripts+notes; 2× Audio/BT menu; hold Quick Download
; -----------------------------------------------------------------------------
...
; [WM module] Win+Alt+Shift+9: 1× Push scripts+notes; 2× Audio/BT menu; hold Quick Download -> WindowManagement\audio_bt_menu.ahk
...
;    - Win+Alt+Shift+9: 1× Push scripts+notes (Utility [G]); 2× Audio / Bluetooth menu; hold 700ms+ Quick Download (configured sequences → Desktop cut)
