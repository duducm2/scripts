...
;   WindowManagement\audio_bt_menu.ahk        - Win+Alt+Shift+9: 1× Quick Download (click sequences); 2× Audio/BT menu
; -----------------------------------------------------------------------------
...
; [WM module] Win+Alt+Shift+9: 1× Quick Download (click sequences); 2× Audio/BT menu -> WindowManagement\audio_bt_menu.ahk
...
;    - Win+Alt+Shift+9: 1× Quick Download (configured sequences → Desktop cut); 2× Audio / Bluetooth menu
