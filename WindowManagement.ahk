...
;   WindowManagement\audio_bt_menu.ahk        - Win+Alt+Shift+9: 1× Quick Download; 2× Audio/BT menu; hold Push scripts+notes
; -----------------------------------------------------------------------------
...
; [WM module] Win+Alt+Shift+9: 1× Quick Download; 2× Audio/BT menu; hold Push scripts+notes -> WindowManagement\audio_bt_menu.ahk
...
;    - Win+Alt+Shift+9: 1× Quick Download (configured sequences → Desktop cut); 2× Audio / Bluetooth menu; hold 700ms+ Push scripts+notes (Utility [G])
