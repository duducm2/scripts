...
| Modules in [`AppLaunchers/`](../AppLaunchers/)         | 0            | **7 files**                 |
...
| `hotkey_editor_file_search.ahk` | 195    | `#!+k` file search across VS Code and Cursor windows |
...
Load order: hotkey_context_browser → desktop_explorer → launch_hotkeys → hotkey_editor_file_search → pomodoro_timer → center_mouse → hotkey_clipangel.
