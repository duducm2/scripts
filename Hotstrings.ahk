...
:o:cgrammar::
{
    InsertText("Correct grammar and spelling. Remove any dashes from the text. The text should be plain with no styles. Give back only the text. Use lininebreaks and a space betetween paragraphs and look like a human.")
}
...
InitHotstringsCheatSheet() {
    ...
    RegisterHotstring(":o:cgrammar", "Correct grammar and spelling. Remove any dashes from the text. The text should be plain with no styles. Give back only the text. Use linebreaks and a space between paragraphs and look like a human.")
