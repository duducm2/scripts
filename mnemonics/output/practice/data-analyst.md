...
<details open>
<summary><strong>Memory Palace 15: Aggregation & GROUP BY</strong> · Character: Claude Monet · 2 beasts · 2 atoms</summary>
...
**Story**
A Bone kitten pours a giant snowball through a roaring blender, using a plastic funnel lined with a coffee filter to catch only the perfectly crushed ice at the end.
...
**Story**
A colossal bloodhound uses a vacuum trunk to suck scattered items off a glowing restaurant menu, spitting them neatly into a massive manila folder.
...
<details>
<summary><strong>Memory Palace 14: CTEs & Subqueries</strong> · Character: Frédéric Chopin · 5 beasts · 5 atoms</summary>
...
**Concept**
💡 [<kbd><strong><u>Window Function Filtering</u></strong></kbd>] [I <kbd><strong><u>wrap</u></strong></kbd> the query in a subquery or CTE] [to <kbd><strong><u>filter</u></strong></kbd> results] [based on a <kbd><strong><u>window function</u></strong></kbd>] — Note: This is necessary because window functions execute after the WHERE clause.

🔑 **Keywords**

- [**Window Function Filtering**] → [strainer]
- [**wrap**] → [blanket]
- [**filter**] → [sieve]
- [**window function**] → [window]

**Quote**
“what I can do is take this table turn it into a subquery and I'm going to only return the cases where the popularity is 1 2 or 3”

**Story**
A Bone frog wraps a glowing glass window inside a thick wool blanket and shoves it through a metal sieve to filter out chunks of stinking mud.

### 🟧 [Bg] Bone goat

**Concept**
💡 [<kbd><strong><u>Common Table Expression</u></strong></kbd>] [I <kbd><strong><u>extract</u></strong></kbd> nested subquery logic] [to the <kbd><strong><u>top</u></strong></kbd> of the script] [using the <kbd><strong><u>WITH keyword</u></strong></kbd>] — Note: This creates a temporary, named result set that improves script readability.

🔑 **Keywords**

- [**Common Table Expression**] → [blackboard]
- [**extract**] → [tweezers]
- [**top**] → [crown]
- [**WITH keyword**] → [ribbon]

**Quote**
“now this whole section is called a CTE and we know that because it has this with keyword that signifies that this is a CTE and now we can reference MP just like any other table”

**Story**
A Bone goat uses giant tweezers to pull glowing nested code blocks out of a blackboard, tying them to the crown of the board with a bright red ribbon.

### 🟧 [Bh] Bone Hydra

**Concept**
💡 [<kbd><strong><u>CTE Reusability</u></strong></kbd>] [I <kbd><strong><u>reference</u></strong></kbd> a defined CTE alias] [<kbd><strong><u>multiple times</u></strong></kbd>] [in the <kbd><strong><u>main query</u></strong></kbd>] — Note: This avoids rewriting the entire subquery for each use.

🔑 **Keywords**

- [**CTE Reusability**] → [stamp]
- [**reference**] → [laser]
- [**multiple times**] → [mirrors]
- [**main query**] → [scroll]

**Quote**
“we've referenced MP or this table two times one's here and then one's here as well and that's something you can only do with ctes not subqueries”

**Story**
A Bone Hydra fires a green laser from its eyes that bounces off multiple mirrors, burning the same exact stamp onto a long parchment scroll over and over.
...
**Story**
A mammoth bison drags a humming chest freezer into a camping tent to store a wooden clipboard, smashing a glowing hamster wheel to stop it from spinning again.

### 🟧 [Bj] Bone jester

**Concept**
💡 [<kbd><strong><u>Recursive CTE</u></strong></kbd>] [I <kbd><strong><u>loop</u></strong></kbd> a query to reference itself] [to generate sequences or <kbd><strong><u>hierarchical data</u></strong></kbd>] — Note: It uses an initial anchor value and a UNION ALL command to stack subsequent rows.

🔑 **Keywords**

- [**Recursive CTE**] → [staircase]
- [**loop**] → [lasso]
- [**hierarchical data**] → [pyramid]

**Quote**
“recursive CTE are useful in many situations where you need to do something again and again and you need to write a query that references itself”

**Story**
A Bone jester throws a neon lasso up a spiral staircase, catching its own skeletal foot to pull itself up and build an endless glowing pyramid of stacked bones.
...
<details>
<summary><strong>Memory Palace 13: Window Functions & OVER</strong> · Character: Erik Satie · 5 beasts · 5 atoms</summary>
...
**Concept**
💡 [<kbd><strong><u>Window Function</u></strong></kbd>] [I <kbd><strong><u>combine</u></strong></kbd> two parts] [the analytical function and the <kbd><strong><u>OVER clause</u></strong></kbd>] — Note: The <kbd><strong><u>OVER clause</u></strong></kbd> defines how I view the data when applying the function.

🔑 **Keywords**

- [**Window Function**] → [puppet]
- [**combine**] → [puzzle]
- [**OVER clause**] → [window]

**Quote**
“a window function always has two components this second part here defines your window and this first part here is called your function so the way to think about it is that your window here is how you want to be viewing your data when you're applying your function”

**Story**
A giant bat smashes a puzzle piece labeled 'function' into a glowing glass window; the glass shivers and views the street through warped lenses.

### 🟧 [Bb] Bone bird of paradise

**Concept**
💡 [<kbd><strong><u>OVER Clause</u></strong></kbd>] [I define the specific <kbd><strong><u>subset</u></strong></kbd> of table data] [that the window function <kbd><strong><u>evaluates</u></strong></kbd>] — Note: It allows me to partition or reorder the data for the calculation.
...
**Quote**
“the way the Over clause works is basically what do I want to be looking at in my table when I'm labeling all the row numbers”

**Story**
A Bone bird of paradise slices a massive wooden table into floating geometric subsets with its wings, weighing each slice on bone scales.

### 🟧 [Bc] Bone cat

**Concept**
💡 [<kbd><strong><u>Ranking Functions</u></strong></kbd>] [I <kbd><strong><u>handle</u></strong></kbd> underlying data ties] [in <kbd><strong><u>distinct ways</u></strong></kbd>] — Note: ROW_NUMBER ignores ties, RANK skips subsequent numbers, and DENSE_RANK assigns ties without skipping.

🔑 **Keywords**

- [**Ranking Functions**] → [trophy]
- [**handle**] → [gloves]
- [**distinct ways**] → [fork]

**Quote**
“for rank you can see that there's a tie here between Isabella and Olivia and they both show that five and then for dense rank it goes from 1 to 9 and it also includes that tie but then it goes right to six instead of skipping over it”

**Story**
A Bone cat wearing boxing gloves punches a golden trophy into three distinct forks; each fork magically ties its prongs together into different tight knots.

### 🟧 [Bd] Bone dragon

**Concept**
💡 [<kbd><strong><u>Navigation Functions</u></strong></kbd>] [I <kbd><strong><u>retrieve</u></strong></kbd> data values] [relative to a row's <kbd><strong><u>current position</u></strong></kbd>] [within its <kbd><strong><u>window</u></strong></kbd>] — Note: Functions like LEAD and LAG pull values from subsequent or preceding rows.

🔑 **Keywords**

- [**Navigation Functions**] → [compass]
- [**retrieve**] → [hook]
- [**current position**] → [map]
- [**window**] → [pane]

**Quote**
“there's also lead and lag that will return the next or previous rows values within each window”

**Story**
A Bone dragon throws a heavy iron hook through a glowing glass pane, snagging a compass off a map to yank previous and future rows into the present.

### 🟧 [Be] bee

**Concept**
💡 [<kbd><strong><u>PARTITION BY</u></strong></kbd>] [I <kbd><strong><u>divide</u></strong></kbd> rows into smaller subsets] [based on a <kbd><strong><u>specific column</u></strong></kbd>] — Note: The window function resets its calculation for each new partition group it encounters.

🔑 **Keywords**

- [**PARTITION BY**] → [wall]
- [**divide**] → [axe]
- [**specific column**] → [boxes]

**Quote**
“the way to do this split within window functions is to use a partition by and in this case we want to partition by gender so within this gender column we want to split the rows into a boy group and a girl group”

**Story**
A colossal bee swings a heavy axe to chop a brick wall into smaller wooden boxes, resetting its buzzing timer each time it finishes a box.
