; Upstream: https://github.com/Descolada/AHK-v2-libraries/blob/main/Lib/Media.ahk
/**
...
class Media {
    static IID_IAsyncInfo := "{00000036-0000-0000-C000-000000000046}"
        ...
        , PlaybackStatus := { Closed: 0, Opened: 1, Changing: 2, Stopped: 3, Playing: 4, Paused: 5, base: this.Enumeration
            .Prototype }
        , PlaybackType := { Unknown: 0, Audio: 1, Video: 2, Image: 3, base: this.Enumeration.Prototype }

    static __New() {
        this.prototype.__Media := this, this.IBase.prototype.__Media := this, this.EventHandler.prototype.__Media :=
            this
        this.Session.base := this.IBase, this.Session.prototype.base := this.IBase.prototype ; Session extends Media.IBase

        this.GlobalSystemMediaTransportControlsSessionManagerStatics := this.CreateClass(
            "Windows.Media.Control.GlobalSystemMediaTransportControlsSessionManager",
            "{2050c4ee-11a0-57de-aed7-c97c70338245}")
        ComCall(6, this.GlobalSystemMediaTransportControlsSessionManagerStatics, "ptr*",
            GlobalSystemMediaTransportControlsSessionManager := Media.IBase())   ; GlobalSystemMediaTransportControlsSessionManager.RequestAsync
    ...
    class Session {
        ...
        Title {
            get => (ComCall(6, this.IGlobalSystemMediaTransportControlsSessionMediaProperties, "ptr*", hString := this.__Media
                .HString()), hString[])
        }
        Subtitle {
            get => (ComCall(7, this.IGlobalSystemMediaTransportControlsSessionMediaProperties, "ptr*", hString := this.__Media
                .HString()), hString[])
        }
        AlbumArtist {
            get => (ComCall(8, this.IGlobalSystemMediaTransportControlsSessionMediaProperties, "ptr*", hString := this.__Media
                .HString()), hString[])
        }
        Artist {
            get => (ComCall(9, this.IGlobalSystemMediaTransportControlsSessionMediaProperties, "ptr*", hString := this.__Media
                .HString()), hString[])
        }
        AlbumTitle {
            get => (ComCall(10, this.IGlobalSystemMediaTransportControlsSessionMediaProperties, "ptr*", hString := this
                .__Media.HString()), hString[])
        }
        TrackNumber {
            get => (ComCall(11, this.IGlobalSystemMediaTransportControlsSessionMediaProperties, "int*", &value := 0),
            value)
        }
        Genres {
            get {
                ComCall(12, this.IGlobalSystemMediaTransportControlsSessionMediaProperties, "ptr*", IVector := this.__Media
                    .IBase())
        ...
        AlbumTrackCount {
            get => (ComCall(13, this.IGlobalSystemMediaTransportControlsSessionMediaProperties, "int*", &value := 0),
            value)
        }
        Thumbnail {
            get {
                ComCall(15, this.IGlobalSystemMediaTransportControlsSessionMediaProperties, "ptr*",
                    IRandomAccessStreamReference := this.__Media.IBase())
        ...
        StartTime {
            get => (ComCall(6, this.IGlobalSystemMediaTransportControlsSessionTimelineProperties, "int64*", &value := 0
            ), value // 10000000)
        }
        EndTime {
            get => (ComCall(7, this.IGlobalSystemMediaTransportControlsSessionTimelineProperties, "int64*", &value := 0
            ), value // 10000000)
        }
        MinSeekTime {
            get => (ComCall(8, this.IGlobalSystemMediaTransportControlsSessionTimelineProperties, "int64*", &value := 0
            ), value // 10000000)
        }
        MaxSeekTime {
            get => (ComCall(9, this.IGlobalSystemMediaTransportControlsSessionTimelineProperties, "int64*", &value := 0
            ), value // 10000000)
        }
        Position {
            get => (ComCall(10, this.IGlobalSystemMediaTransportControlsSessionTimelineProperties, "int64*", &value :=
                0), value // 10000000)
        }
        LastUpdatedTime {
            get => (ComCall(11, this.IGlobalSystemMediaTransportControlsSessionTimelineProperties, "int64*", &value :=
                0), value // 10000000)
        }
         ...
         */
        PlaybackStatus {
            get => (ComCall(7, this.IGlobalSystemMediaTransportControlsSessionPlaybackInfo, "int*", &value := 0), value
            ) ; get_PlaybackStatus
        }
        /**
        ...
        PlaybackType {
            get {
                ComCall(8, this.IGlobalSystemMediaTransportControlsSessionPlaybackInfo, "ptr*",
                    IReferenceMediaPlaybackType := this.__Media.IBase())
        ...
        AutoRepeatMode {
            get {
                ComCall(9, this.IGlobalSystemMediaTransportControlsSessionPlaybackInfo, "ptr*",
                    IReferenceMediaPlaybackAutoRepeatType := this.__Media.IBase())
        ...
        PlaybackRate {
            get => (ComCall(10, this.IGlobalSystemMediaTransportControlsSessionPlaybackInfo, "double*", &value := 0),
            value)
        }
        ; True if the session is currently shuffling; otherwise, false.
        IsShuffleActive {
            get => (ComCall(11, this.IGlobalSystemMediaTransportControlsSessionPlaybackInfo, "int*", &value := 0),
            value)
        }
        ...
        IGlobalSystemMediaTransportControlsSessionPlaybackControls {
            get {
                ComCall(6, this.IGlobalSystemMediaTransportControlsSessionPlaybackInfo, "ptr*",
                    IGlobalSystemMediaTransportControlsSessionPlaybackControls := this.__Media.IBase())
        ...
        IsPlayEnabled {
            get => (ComCall(6, this.IGlobalSystemMediaTransportControlsSessionPlaybackControls, "int*", &value := 0),
            value)
        }
        IsPauseEnabled {
            get => (ComCall(7, this.IGlobalSystemMediaTransportControlsSessionPlaybackControls, "int*", &value := 0),
            value)
        }
        IsStopEnabled {
            get => (ComCall(8, this.IGlobalSystemMediaTransportControlsSessionPlaybackControls, "int*", &value := 0),
            value)
        }
        IsRecordEnabled {
            get => (ComCall(9, this.IGlobalSystemMediaTransportControlsSessionPlaybackControls, "int*", &value := 0),
            value)
        }
        IsFastForwardEnabled {
            get => (ComCall(10, this.IGlobalSystemMediaTransportControlsSessionPlaybackControls, "int*", &value := 0),
            value)
        }
        IsRewindEnabled {
            get => (ComCall(11, this.IGlobalSystemMediaTransportControlsSessionPlaybackControls, "int*", &value := 0),
            value)
        }
        IsNextEnabled {
            get => (ComCall(12, this.IGlobalSystemMediaTransportControlsSessionPlaybackControls, "int*", &value := 0),
            value)
        }
        IsPreviousEnabled {
            get => (ComCall(13, this.IGlobalSystemMediaTransportControlsSessionPlaybackControls, "int*", &value := 0),
            value)
        }
        IsChannelUpEnabled {
            get => (ComCall(14, this.IGlobalSystemMediaTransportControlsSessionPlaybackControls, "int*", &value := 0),
            value)
        }
        IsChannelDownEnabled {
            get => (ComCall(15, this.IGlobalSystemMediaTransportControlsSessionPlaybackControls, "int*", &value := 0),
            value)
        }
        IsPlayPauseToggleEnabled {
            get => (ComCall(16, this.IGlobalSystemMediaTransportControlsSessionPlaybackControls, "int*", &value := 0),
            value)
        }
        IsShuffleEnabled {
            get => (ComCall(17, this.IGlobalSystemMediaTransportControlsSessionPlaybackControls, "int*", &value := 0),
            value)
        }
        IsRepeatEnabled {
            get => (ComCall(18, this.IGlobalSystemMediaTransportControlsSessionPlaybackControls, "int*", &value := 0),
            value)
        }
        IsPlaybackRateEnabled {
            get => (ComCall(19, this.IGlobalSystemMediaTransportControlsSessionPlaybackControls, "int*", &value := 0),
            value)
        }
        IsPlaybackPositionEnabled {
            get => (ComCall(20, this.IGlobalSystemMediaTransportControlsSessionPlaybackControls, "int*", &value := 0),
            value)
        }

        Play() => (ComCall(10, this, "ptr*", IAsync := this.__Media.IBase()), this.__Media.WaitForAsync(&IAsync, "int*"
        ), IAsync)
        Pause() => (ComCall(11, this, "ptr*", IAsync := this.__Media.IBase()), this.__Media.WaitForAsync(&IAsync,
            "int*"), IAsync)
        Stop() => (ComCall(12, this, "ptr*", IAsync := this.__Media.IBase()), this.__Media.WaitForAsync(&IAsync, "int*"
        ), IAsync)
        Record() => (ComCall(13, this, "ptr*", IAsync := this.__Media.IBase()), this.__Media.WaitForAsync(&IAsync,
            "int*"), IAsync)
        FastForward() => (ComCall(14, this, "ptr*", IAsync := this.__Media.IBase()), this.__Media.WaitForAsync(&IAsync,
            "int*"), IAsync)
        Rewind() => (ComCall(15, this, "ptr*", IAsync := this.__Media.IBase()), this.__Media.WaitForAsync(&IAsync,
            "int*"), IAsync)
        SkipNext() => (ComCall(16, this, "ptr*", IAsync := this.__Media.IBase()), this.__Media.WaitForAsync(&IAsync,
            "int*"), IAsync)
        SkipPrevious() => (ComCall(17, this, "ptr*", IAsync := this.__Media.IBase()), this.__Media.WaitForAsync(&IAsync,
            "int*"), IAsync)
        ChangeChannelUp() => (ComCall(18, this, "ptr*", IAsync := this.__Media.IBase()), this.__Media.WaitForAsync(&
            IAsync, "int*"), IAsync)
        ChangeChannelDown() => (ComCall(19, this, "ptr*", IAsync := this.__Media.IBase()), this.__Media.WaitForAsync(&
            IAsync, "int*"), IAsync)
        TogglePlayPause() => (ComCall(20, this, "ptr*", IAsync := this.__Media.IBase()), this.__Media.WaitForAsync(&
            IAsync, "int*"), IAsync)
        /**
         * Specifies the auto repeat mode for media playback
         * @param mode 
         ...
         * @returns {Boolean} 
         */
        ChangeAutoRepeatMode(mode) => (ComCall(21, this, "int", mode, "ptr*", IAsync := this.__Media.IBase()), this.__Media
        .WaitForAsync(&IAsync, "int*"), IAsync)
        /**
         ...
         * @returns {Boolean} 
         */
        ChangePlaybackRate(rate) => (ComCall(22, this, "double", rate, "ptr*", IAsync := this.__Media.IBase()), this.__Media
        .WaitForAsync(&IAsync, "int*"), IAsync)
        /**
         ...
         * @returns {Boolean} 
         */
        ChangeShuffleActive(state) => (ComCall(23, this, "int", !!state, "ptr*", IAsync := this.__Media.IBase()), this.__Media
        .WaitForAsync(&IAsync, "int*"), IAsync)
        /**
         ...
         * @returns {Boolean} 
         */
        ChangePlaybackPosition(pos) => (ComCall(24, this, "int", pos * 10000000, "ptr*", IAsync := this.__Media.IBase()),
        this.__Media.WaitForAsync(&IAsync, "int*"), IAsync)

        AddTimelinePropertiesChangedEvent(funcObj) {
            local handler := this.__Media.CreateEventHandler(funcObj, this.__Media.IID_ITypedEventHandler_TimelinePropertiesChangedEvent
            ), token
            ComCall(25, this, "ptr", handler.ptr, "int64*", &token := 0)
            handler.token := token, handler.Session := this, handler.DefineProp("Remove", { Call: ((this) => this.HasOwnProp(
                "token") ? ComCall(26, this.Session, "int64", this.token) : 0) })
            return handler
        }

        AddPlaybackInfoChangedEvent(funcObj) {
            local handler := this.__Media.CreateEventHandler(funcObj, this.__Media.IID_ITypedEventHandler_PlaybackInfoChangedEvent
            ), token
            ComCall(27, this, "ptr", handler.ptr, "int64*", &token := 0)
            handler.token := token, handler.Session := this, handler.DefineProp("Remove", { Call: ((this) => this.HasOwnProp(
                "token") ? ComCall(28, this.Session, "int64", this.token) : 0) })
            return handler
        }

        AddMediaPropertiesChangedEvent(funcObj) {
            local handler := this.__Media.CreateEventHandler(funcObj, this.__Media.IID_ITypedEventHandler_MediaPropertiesChangedEvent
            ), token
            ComCall(29, this, "ptr", handler.ptr, "int64*", &token := 0)
            handler.token := token, handler.Session := this, handler.DefineProp("Remove", { Call: ((this) => this.HasOwnProp(
                "token") ? ComCall(30, this.Session, "int64", this.token) : 0) })
            return handler
        }
    }
    ...
    static GetCurrentSession() {
        ComCall(6, this.GlobalSystemMediaTransportControlsSessionManager, "ptr*",
            GlobalSystemMediaTransportControlsSession := this.Session()) ; GlobalSystemMediaTransportControlsSessionManager.GetCurrentSession
    ...
    static GetSessions() {
        ...
        ComCall(7, this.GlobalSystemMediaTransportControlsSessionManager, "ptr*",
            IGlobalSystemMediaTransportControlsSessionList := this.IBase())
    ...
    static AddCurrentSessionChangedEvent(funcObj) {
        local handler := this.CreateEventHandler(funcObj, this.IID_ITypedEventHandler_CurrentSessionChangedEvent),
        token
        ComCall(8, this.GlobalSystemMediaTransportControlsSessionManager, "ptr", handler.ptr, "int64*", &token := 0)
        handler.token := token, handler.DefineProp("Remove", { Call: ((this) => this.HasOwnProp("token") ? ComCall(9,
            this.__Media.GlobalSystemMediaTransportControlsSessionManager, "int64", this.token) : 0) })
        return handler
    }
    ...
    static AddSessionsChangedEvent(funcObj) {
        ...
        handler.token := token, handler.DefineProp("Remove", { Call: ((this) => this.HasOwnProp("token") ? ComCall(11,
            this.__Media.GlobalSystemMediaTransportControlsSessionManager, "int64", this.token) : 0) })
        return handler
    }
    ...
    static CreateClass(str, interface?) {
        ...
        if !IsSet(interface) {
            ...
            result := DllCall("Combase.dll\RoGetActivationFactory", "ptr", hString, "ptr", GUID, "ptr*", cls := this.IBase(),
            "uint")
        }
        if (result != 0) {
    ...
    class EventHandler {
        Invoke(pSelf, pSender, pArgs) {
            if this.IID = this.__Media.IID_ITypedEventHandler_MediaPropertiesChangedEvent || this.IID = this.__Media.IID_ITypedEventHandler_PlaybackInfoChangedEvent ||
                this.IID = this.__Media.IID_ITypedEventHandler_TimelinePropertiesChangedEvent
                ObjAddRef(pSender), ObjAddRef(pArgs), SetTimer(this.EventHandler.Bind(this.__Media.Session(pSender),
                this.__Media.IBase(pArgs)), -1)
            else
                ObjAddRef(pSender), ObjAddRef(pArgs), SetTimer(this.EventHandler.Bind(this.__Media.IBase(pSender), this
                .__Media.IBase(pArgs)), -1)
            return 0
        }
    ...
    static CreateEventHandler(funcObj, iid) {
        ...
        buf := Buffer(A_PtrSize * 6), handler := this.EventHandler(), handler.IID := iid, handler.__Media := this,
        handler.EventHandler := funcObj, handler.Buffer := buf, handler.Ptr := buf.ptr, handlerFunc := handler.Invoke
        /**
        ...
        CallbackCreate(handlerFunc.Bind(handler), , 3), buf)
        ...
        handler.DefineProp("__Delete", { call: (this, *) => (this.__Media.RegisteredEvents.Delete(this.ptr), ObjAddRef(
            ObjPtr(this)), CallbackFree(cQI), CallbackFree(cAF), CallbackFree(cR), CallbackFree(cF), this.Remove()) })
        ...
        QueryInterface(pSelf, pRIID, pObj) { ; Credit: https://github.com/neptercn/UIAutomation/blob/master/UIA.ahk
            ...
            return (str = "{00000000-0000-0000-C000-000000000046}") || (this.RegisteredEvents.Has(pSelf) && str = this.RegisteredEvents[
                pSelf]) ? (NumPut("ptr", pSelf, pObj), ObjAddRef(pSelf)) * 0 : 0x80004002 ; E_NOINTERFACE
        }
    ...
    class HString {
        static Create(str) => (DllCall("Combase.dll\WindowsCreateString", "wstr", str, "uint", StrLen(str), "ptr*", &
        hString := 0), hString)
        static Delete(hString) => DllCall("Combase.dll\WindowsDeleteString", "ptr", hString)
        __New(str?) => this.DefineProp("ptr", { value: IsSet(str) ? (DllCall("Combase.dll\WindowsCreateString", "wstr",
            str, "uint", StrLen(str), "ptr*", &hString := 0), hString) : 0 })
        __Item[*] => (buf := DllCall("Combase.dll\WindowsGetStringRawBuffer", "ptr", this, "uint*", &length := 0, "ptr"
        ), StrGet(buf, "UTF-16"))
        __Delete() {
            if this.ptr
