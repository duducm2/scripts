...
def seed():
    ...
    bud_pairs = [
        ("Mercado", "3000,00", "1039,26"),
        ("Alimentação", "300,00", "603,43"),
        ("Beleza", "150,00", "100,00"),
        ("Lazer", "600,00", "167,28"),
        ("Saúde", "1000,00", "670,27"),
        ("Carro", "400,00", "696,59"),
        ("Contas de casa", "2300,00", "0,00"),
        ("Educação", "400,00", "139,77"),
        ("Eletrônicos", "50,00", "733,44"),
