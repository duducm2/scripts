...
Place: empty monitor → maximize; else free half → 50/50; else maximize in place. Close/minimize of a pair **heals** (maximizes) the leftover companion. Details and busy overlays: canon doc above.
