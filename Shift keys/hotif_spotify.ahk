...
; Implementation: Utils\spotify_immerse.ahk (shared with D2C [P]).
+i:: SpotifyImmerse()
...
; Immersion helpers (SpotifyToggleFullscreen, FindHeaderPlayButton, SpotifyImmerse)
; live in Utils\spotify_immerse.ahk (included via Utils.ahk).
