...
(
    ...
    🔁 [P]Constant [P]asting ↓ (delimiter; native Ctrl+Alt+V paste+next; toggle stop)
    🔁 [B]Constant pasting ↑ ([B]ottom-up; delimiter; native Ctrl+Alt+B paste+prev; toggle stop)
