...
(
    ...
    === DESKTOP ===
    [Win+Alt+Shift+O] > Newest Desktop item: 1× cut (return to previous window); 2× open; 3× paste clipboard file copy to Desktop (or Cursor/VS Code active editor file); hold 700ms+ copy path as text
