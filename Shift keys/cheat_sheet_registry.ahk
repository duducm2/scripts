...
(
    ...
    [Win+Alt+Shift+P] > {AI_PROVIDER}: 1× copy last message; 2× (within 400ms) copy last code snippet, then 3s [Y]/N] Save last clip to Desktop?
    ...
    [ZMK L0 · X thumb] hold > Win+Alt+Shift+X — Memory Palace
