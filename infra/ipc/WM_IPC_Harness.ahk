...
; reports p50/p95 and jitter. From repo root, start daemon: python infra\python\wm_daemon.py
...
if (!WMIPC_ConnectForHarness()) {
    MsgBox("Harness: Could not connect to pipe " WM_PIPE_NAME "`. From repo root: python infra\python\wm_daemon.py",
        "WM IPC Harness", "Icon!")
    ExitApp(1)
}
