...
- Lone maximized / work-area = **1 slot**; free half remains for Y / Ctrl+6.
...
| --------------------------- | ------------------------------------------------- | -------------------------------------------------------------------- | ---------------------- |
| **New window (Place)**      | `ProcessPending` → `Place`                        | Empty → maximize there; else MaximizeInPlace. No free-half SnapPair. | INFO toast             |
