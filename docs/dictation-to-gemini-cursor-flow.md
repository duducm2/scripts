...
5. **If the flow sent your text to Gemini** (you chose **Y**, **G**, **A**, **T**, **D**, or let the first banner time out), after Gemini responds you see **Copy response?**  
...
flowchart TB
    ...
    User6s --> |"D"| FinalizeFinance["Finance daily plus CSVs plus dictation"]
