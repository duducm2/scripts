...
5. **If the flow sent your text to Gemini** (you chose **Y**, **G**, **A**, **T**, or let the first banner time out), after Gemini responds you see **Response ready — what next?** (same destination keys as `#\!+P` post-copy).  
   ...
   Each destination key **copies the reply first**, then runs the same action as `#\!+P`: **P** = Copy only (same as `#\!+P` 1× without a destination), **Y** = Desktop export, **F** = Favorite, **C** = Transfer to Cursor, **R** = Read aloud (omitted for Gemini Enterprise), **W** = Paste to a visible window, **O** = Clip Angel Edit, **N** / **Esc** / timeout = dismiss with **no** copy.  
...
flowchart TB
    ...
    BannerCopy --> UserCopy{"P / Y / F / C / R / W / O / N / Esc / timeout"}
...
| 2    | **Response ready — what next?** (5s)   | Same strip as `#\!+P` plus **P** Copy-only: **P** Copy, **Y** Desktop, **F** Favorite, **C** Transfer, **R** Read (omit Enterprise), **W** Paste window, **O** Clip Angel, **N** / **Esc** / timeout = No. Each destination copies the reply first (`DoCopyCore` with `#\!+P`-style quality gates), then the destination action.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | N / Esc / timeout end with no copy. Destination keys copy then act.                                                                                                                                                                                                                                              |
