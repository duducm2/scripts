...
flowchart TB
    ...
    ShowAndWait --> User6s{"G / A / T / B / Y / S / V / W / E / F / O / N / timeout"}
    ...
    User6s --> |"B"| FinalizeMobills["Preset Mobills plus dictation"]
    FinalizePreset --> PasteGemini
    FinalizeAiopt --> PasteGemini
    FinalizeMtask --> PasteGemini
    FinalizeMobills --> PasteGemini
