...
5. **If the flow sent your text to Gemini** (you chose **Y**, **G**, **A**, **T**, or let the first banner time out), after Gemini responds you see **Copy response?**  
   (**D** does not show this banner: it waits for the stop/streaming control to disappear, downloads, and imports daily transactions automatically.)  
