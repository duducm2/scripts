...
Until chat-response UIA exists for Enterprise (copy / read aloud / TTS / pronunciation), those chords **do not** silently fall back to Copilot when Enterprise is the resolved companion. They activate Enterprise and focus the omnibar/composer (same idea as I), with the ready chime.
