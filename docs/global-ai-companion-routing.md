...
| Win+Alt+Shift+P      | 1×/2×: destination banner first (Desktop/Favorite/Transfer/Read/Paste window/Clip Angel); copy + act only after choice | Same + Copilot copy paths; Read uses Copilot read-aloud | Same; banner omits Read (Enterprise)                                  |
