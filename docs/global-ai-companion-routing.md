...
| Win+Alt+Shift+P      | 1×/2×: destination banner first; Y/C/W pick UI then copy+act; F/R/O copy then act | Same + Copilot copy paths; Read uses Copilot read-aloud | Same; banner omits Read (Enterprise)                                  |
