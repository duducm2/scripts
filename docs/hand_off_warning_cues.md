...
| `Utils.ahk` (`D2C_FlowManager.OnActionTimeout` / **N** / **Esc**)                                                               | **Response ready** banner times out or user dismisses                                                                                                                                    | End flow with **no** copy (aligned with `#\!+P` post-copy timeout)                                                                                                                                                          | **No** Hand Off cue                                                                                    |
