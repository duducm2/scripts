...
- **Shared automation open:** [`ClipAngel_OpenForAutomation`](../Utils/clip_angel_activate.ahk) (`mode` all|favorites, optional `suppressVisual`) = one show/layout + [`ClipAngel_ApplyMarkFilterMode`](../Utils/clip_angel_favorite.ahk) + one [`ClipAngel_FastEnsureRow0`](../Utils/clip_angel_favorite.ahk). Used by Alt+P/B, favorite mark, paste/export/`#!+7`, and UI-merge fallback. **Single UIA `root`:** [`ClipAngel_UiaEnsureRow0Selected`](../Utils/clip_angel_favorite.ahk) accepts optional `root`; MarkFilter element is cached during filter polls.
