...
Palace_ShowHelp() {
    ...
    "Esc / Backspace — main menu. [L] Plans · [J] import plan pack · [I] mnemonic pack · [O] plans on GitHub · [P] push. [R] regen Markdown. Browse [L] plans under a study. Dashboard: P plans · M method · L latest · Save (Plans panel)."
    )
