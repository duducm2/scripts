...
ClickSeqScript_Catalog() {
    return [
        { id: "scrollFeedBottom", title: "Scroll feed to bottom" },
        { id: "desktopWait", title: "Wait for new Desktop file" },
        { id: "desktopCut", title: "Cut newest Desktop item" },
        { id: "focusCompanion", title: "Focus AI companion" }
    ]
}
